...
namespace Script
{
    ...
    public partial class WorkFlowScript
    {
        ...
        private void set_DbFetchData141_checkpoints(STActivityBase activity)
        {
            // Checkpoint 1
            ...
            BindDirection actualBindDirection1 = new BindDirection(_flow.DbFetchData141, actualValueGetter1, actualValueSetter1);
